  ...
  return (
    <footer className="bg-black text-gray-300 py-8">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-1 grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white text-lg sm:text-xl font-semibold mb-4">About CodeCap</h3>
            <p className="text-sm sm:text-md font-semibold">
              CodeCap is a leading platform for developers to learn, share, and build their careers. Join our community and take your coding skills to the next level.
            </p>
          </div>
          <div>
            <h3 className="text-white text-lg sm:text-xl font-semibold mb-4">Quick Links</h3>
            <ul className="text-sm sm:text-md font-semibold space-y-2">
        ...
        <div className="mt-10 pt-8 border-t border-gray-700 text-center text-sm sm:text-lg font-semibold">
          <p>&copy; {currentYear}{" "} 
            <a 
